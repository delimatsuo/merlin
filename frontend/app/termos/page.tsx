        ...
        <div className="space-y-10">
          <section>
            ...
            <p className="text-sm text-foreground/80 leading-relaxed">
              ...
              <Link href="/privacidade" className="text-foreground font-medium underline underline-offset-4 decoration-foreground/30 hover:decoration-foreground transition-colors">
                Politica de Privacidade
              </Link>
